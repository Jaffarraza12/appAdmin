        ...
        @section('content')
            ...
            <script type="text/javascript">
                bkLib.onDomLoaded(function() {
                    new nicEditor({fullPanel : true,maxHeight : 100}).panelInstance('input-description');
                  });
            </script>
                                    ...
                                    <div class="kt-portlet">
                                        <div class="kt-portlet__body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-3">
                                                    <input type="text" class="form-control" name="sku"  value="{{(old('sku') ) ? old('sku') :  $product->sku}}" id="input-sku" />
