     ...
     <div class="kt-portlet kt-portlet--tabs">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-toolbar">
                <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-success" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#tab_shipping" role="tab">
        ...
        <div class="kt-portlet__body">
            <div class="tab-content">
                <div class="tab-pane active" id="tab_shipping" role="tabpanel">
                        ...
                        <form class="kt-form kt-form--label-right">
                            <div class="kt-portlet__body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="text" value="{{$order->name}}" id="input-name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="input-email" class="col-2 col-form-label">Email</label>
                                    <div class="col-10">
                                        <input class="form-control" type="email" value="{{$order->email}}" id="input-email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="input-tell" class="col-2 col-form-label">Phone</label>
                                    <div class="col-10">
                                        <input class="form-control" type="tel" value="{{$order->phone}}" id="input-tell">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="input-address" class="col-2 col-form-label">Address</label>
                                    <div class="col-10">
                                        <textarea class="form-control" name="address" id="input-address">{{$order->shipping_address}}</textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="input-zone" class="col-2 col-form-label">Zones</label>
                                    <div class="col-10">
                                        <select class="form-control" name="address" id="input-zone">
                                            @foreach($zones as $zone):
                                                <option {{ ($zone->zone_id == $order->shipping_zone) ? 'selected="selected"' : '' }} value="{{$zone->zone_id}}">{{$zone->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="input-zone" class="col-2 col-form-label">City</label>
                                    <div class="col-10">
                                        <select class="form-control" name="address" id="input-zone">
                                            @foreach($cities as $city)
                                                <option {{ ($city->zone_city_id == $order->shipping_city) ? 'selected="selected"' : '' }}  value="{{$city->zone_city_id}}">{{$city->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
